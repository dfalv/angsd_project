...
output_path=$(echo "/athena/angsd/scratch/daf2042/2021_12_01_inv3_12WR_2D-Ras_Chandwani-DF-11596/trimmed/deeptools_out/multiBW_pca")
sample_name=$(echo "${1}" | cut -d"_" -f1,2)

plotPCA -in ${input_path}/multiBW_summary_out.npz \
  -o ${output_path}/PCA_inv3_multiBW.svg \
